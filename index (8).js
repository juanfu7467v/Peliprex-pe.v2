...
// ✅ FIX: Aumentado a 5 minutos para evitar ciclos constantes de reinicio en Fly.io
...
// Esto elimina el error "instance refused connection".
function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    ...
    // 2. ✅ Cargar datos externos EN SEGUNDO PLANO (sin bloquear el Event Loop)
    //    Fly.io ya detectó el puerto abierto. Ahora cargamos sin prisa.
    console.log("⏳ Iniciando carga de datos en segundo plano...");

    // Sincronizar usuarios con GitHub (no bloquea el servidor)
    ...
    // Cargar catálogo externo (no bloquea el servidor)
